    ...
    <div className="right-side-container">
      <Row className="footer-row">
        <Col className="social-column" md={3} xs={6}>
          ...
          <div>
            <NavLink to="/">Trocas e Devoluções</NavLink>
          </div>
          <div>
            <NavLink to="/">Política de Preços</NavLink>
          </div>
        </Col>
        <Col className="social-column" md={3} xs={6}>
          ...
          <div>
            <NavLink to="/">Política de segurança</NavLink>
          </div>
          <div>
            <NavLink to="/">Logistas Parceiros</NavLink>
          </div>
        </Col>
        <Col className="social-column" md={3} xs={6}>
          <div className="header">FALE CONOSCO</div>
          <div>
            <NavLink to="/">(51) 0000-0000</NavLink>
          </div>
          <div>
            <NavLink to="/">contato@yeky.com.br</NavLink>
          </div>
        </Col>
        <Col className="social-column" md={3} xs={6}>
      ...
      <Row className="footer-row">
        <Col className="payment-column" md={6} xs={6}>
          <Row>
            <Col className="header">FORMAS DE PAGAMENTO</Col>
          </Row>
          <div className="icon-container social-icon-container">
        ...
        <Col className="security-column" md={6} xs={6}>
          <div className="header">SITE SEGURO</div>
          <div className="icon-container social-icon-container">
